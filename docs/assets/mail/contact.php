...
if(trim($name) == '') {
	...
	echo '<div class="alert alert-error">Devi inserire il tuo indirizzo email.</div>';
	exit();
	...
	echo '<div class="alert alert-error">Inserisci un messaggio!</div>';
	exit();
}
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<h3>Richiesta inviata con successo!.</h3>";
	echo "<p>Grazie <strong>$name</strong>, abbiamo ricevuto la tua richiesta e ti contatteremo al più presto.</p>";
	echo "</div>";
